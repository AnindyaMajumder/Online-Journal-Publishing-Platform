...
export default function ReportLog({ reports, setReports }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-40">
      <div className="bg-white p-8 rounded shadow-lg w-96">
        <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Report Log</h2>
